...
}).refine((data) => data.channelId || data.dmThreadId, 'Either channelId or dmThreadId must be provided').refine((data) => !data.isEncrypted || (data.nonce && data.encryptionVersion), 'Encrypted messages require nonce and encryptionVersion');
...
}).refine((data) => data.channelId || data.dmThreadId, 'Either channelId or dmThreadId must be provided');
// ============================================
// Reaction Schemas
// ============================================
...
export const startCallSchema = z.object({
    ...
    if (data.scopeType === 'channel')
        return !!data.channelId;
    if (data.scopeType === 'dm')
        return !!data.dmThreadId;
    return false;
