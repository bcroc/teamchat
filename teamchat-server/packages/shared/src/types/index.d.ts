...
export type AuditAction = 'workspace.created' | 'workspace.updated' | 'member.invited' | 'member.removed' | 'member.role_changed' | 'channel.created' | 'channel.deleted' | 'channel.updated' | 'message.deleted' | 'call.started' | 'call.ended';
...
export type ClientCallState = 'idle' | 'ringing_outgoing' | 'ringing_incoming' | 'connecting' | 'in_call' | 'reconnecting' | 'ended';
